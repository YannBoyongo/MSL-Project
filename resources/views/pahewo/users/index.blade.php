<x-pahewo-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            @can('users.manage')
                <a href="{{ route('pahewo.users.create') }}" class="inline-flex items-center rounded-md bg-gray-800 px-4 py-2 text-sm text-white">Nouvel utilisateur</a>
            @endcan
        </div>
    </x-slot>
    <div class="py-12">
                        ...
                        <tbody>
                            @forelse ($users as $user)
                                <tr class="border-b">
                                    ...
                                    <td class="py-2">@can('users.manage')<a href="{{ route('pahewo.users.edit', $user) }}" class="text-indigo-600 hover:underline">Modifier</a>@endcan</td>
                                </tr>
                            @empty

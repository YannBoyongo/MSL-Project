    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                <a href="{{ route('pahewo.reports.price-trends', request()->only('country_id')) }}" class="rounded-lg bg-white p-6 shadow-sm hover:ring-2 hover:ring-indigo-200">
                ...
                <a href="{{ route('pahewo.reports.exchange-rate-trends', request()->only('country_id')) }}" class="rounded-lg bg-white p-6 shadow-sm hover:ring-2 hover:ring-indigo-200">
                ...
                <a href="{{ route('pahewo.reports.claims', request()->only('country_id')) }}" class="rounded-lg bg-white p-6 shadow-sm hover:ring-2 hover:ring-indigo-200">

<x-pahewo-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <a href="{{ route('pahewo.contact-persons.create') }}" class="inline-flex items-center rounded-md bg-gray-800 px-4 py-2 text-sm text-white">Nouveau contact</a>
        </div>
    </x-slot>
    <div class="py-12">
                        ...
                        <tbody>
                            @forelse ($contactPersons as $person)
                                <tr class="border-b">
                                    ...
                                    <td class="py-2"><a href="{{ route('pahewo.contact-persons.edit', $person) }}" class="text-indigo-600 hover:underline">Modifier</a></td>
                                </tr>
                            @empty

    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="rounded-lg bg-white p-6 shadow-sm">
                ...
                <form method="POST" action="{{ route('pahewo.commodity-categories.update', $commodityCategory) }}" class="mt-6 space-y-6">
                    @csrf
                    @method('PUT')
                    @include('pahewo.commodity-categories._form', ['commodityCategory' => $commodityCategory, 'translation' => $translation])

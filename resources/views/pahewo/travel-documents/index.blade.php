    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            @can('travel_documents.manage')
                <a href="{{ route('pahewo.travel-documents.create') }}" class="inline-flex items-center rounded-md bg-gray-800 px-4 py-2 text-sm text-white">Nouveau document</a>
            @endcan
        </div>
    </x-slot>
    <div class="py-12">
                        ...
                        <tbody>
                            @forelse ($travelDocuments as $doc)
                                <tr class="border-b">
                                    ...
                                    <td class="py-2">@can('travel_documents.manage')<a href="{{ route('pahewo.travel-documents.edit', $doc) }}" class="text-indigo-600 hover:underline">Modifier</a>@endcan</td>
                                </tr>
                            @empty

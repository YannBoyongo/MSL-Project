    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            @can('create', App\Models\Claim::class)
                <a href="{{ route('pahewo.claims.create') }}" class="inline-flex items-center rounded-md bg-gray-800 px-4 py-2 text-sm text-white">Nouvelle réclamation</a>
            @endcan
        </div>
    </x-slot>
                        ...
                        <tbody>
                            @forelse ($claims as $claim)
                                <tr class="border-b">
                                    ...
                                    <td class="py-2">
                                        <a href="{{ route('pahewo.claims.show', $claim) }}" class="text-indigo-600 hover:underline">Voir</a>
                                    </td>
                                </tr>
                            @empty

    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="rounded-lg bg-white p-6 shadow-sm">
                ...
                <form method="POST" action="{{ route('pahewo.claims.update', $claim) }}" class="space-y-4">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="flex gap-3">
                        ...
                        <a href="{{ route('pahewo.claims.show', $claim) }}" class="inline-flex items-center rounded-md border px-4 py-2 text-sm">Annuler</a>
                    </div>
                </form>
            </div>
        </div>

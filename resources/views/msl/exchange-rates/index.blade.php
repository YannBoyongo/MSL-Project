    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            @can('exchange_rates.create')
                <a href="{{ route('msl.exchange-rates.create') }}" class="inline-flex items-center rounded-md bg-gray-800 px-4 py-2 text-sm text-white">Enregistrer un taux</a>
            @endcan
        </div>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="rounded-lg bg-white p-6 shadow-sm">
                ...
                <form method="GET" class="mb-4 flex flex-wrap items-end gap-3">
                    ...
                    <a href="{{ route('msl.exchange-rates.index', ['country_id' => $countryId, 'rate_date' => '']) }}" class="self-center text-sm text-gray-600 hover:underline">Toutes les dates</a>
                </form>
                                ...
                                <tr class="border-b">
                                    ...
                                    <td class="py-2">
                                        @can('exchange_rates.update')
                                            <a href="{{ route('msl.exchange-rates.edit', $rate) }}" class="text-indigo-600 hover:underline">Modifier</a>
                                        @endcan
                                    </td>
                                </tr>
                            @empty

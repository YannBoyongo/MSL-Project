...
<div class="space-y-4">
    <div>
        ...
        <x-text-input id="code" name="code" type="text" class="mt-1 block w-full" :value="old('code', $commodityCategory->code ?? '')" required />
    ...
    <div class="flex items-center gap-2">
        <input id="is_active" name="is_active" type="checkbox" value="1" @checked(old('is_active', $commodityCategory->is_active ?? true)) class="rounded border-gray-300">
        <x-input-label for="is_active" value="Catégorie active" />
    </div>
</div>

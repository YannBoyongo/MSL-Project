    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            @can('exchange_rates.create')
                <a href="{{ route('msl.forex-bureaus.create') }}" class="inline-flex items-center rounded-md bg-gray-800 px-4 py-2 text-sm text-white">Nouveau bureau</a>
            @endcan
        </div>
    </x-slot>
                                ...
                                <tr class="border-b">
                                    ...
                                    <td class="py-2">
                                        @can('exchange_rates.update')
                                            <a href="{{ route('msl.forex-bureaus.edit', $bureau) }}" class="text-indigo-600 hover:underline">Modifier</a>
                                        @endcan
                                    </td>
                                </tr>
                            @empty

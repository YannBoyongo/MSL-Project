    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            @can('commodities.create')
                <a href="{{ route('msl.measurement-units.create') }}" class="inline-flex items-center rounded-md bg-gray-800 px-4 py-2 text-sm text-white">Nouvelle unité</a>
            @endcan
        </div>
    </x-slot>
                                ...
                                <tr class="border-b">
                                    ...
                                    <td class="py-2">
                                        @can('commodities.update')
                                            <a href="{{ route('msl.measurement-units.edit', $unit) }}" class="text-indigo-600 hover:underline">Modifier</a>
                                        @endcan
                                    </td>
                                </tr>
                            @empty

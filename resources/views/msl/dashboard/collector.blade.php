    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                <a href="{{ route('msl.commodity-prices.create') }}" class="rounded-lg bg-white p-6 shadow-sm hover:bg-gray-50">
                    <p class="font-semibold">Enregistrer un prix</p>
                    <p class="text-sm text-gray-500">Saisir un nouveau prix journalier</p>
                </a>
                <a href="{{ route('msl.commodity-prices.index') }}" class="rounded-lg bg-white p-6 shadow-sm hover:bg-gray-50">
                    <p class="font-semibold">Prix du jour</p>
                    <p class="text-sm text-gray-500">{{ $todayPriceCount }} prix enregistrés aujourd'hui</p>
                </a>
                <a href="{{ route('msl.exchange-rates.create') }}" class="rounded-lg bg-white p-6 shadow-sm hover:bg-gray-50">

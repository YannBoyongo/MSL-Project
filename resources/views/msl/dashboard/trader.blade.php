    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="grid gap-4 sm:grid-cols-1 md:grid-cols-3">
                ...
                <a href="{{ route('msl.exchange-rates.index') }}" class="rounded-lg bg-white p-6 shadow-sm hover:bg-gray-50">
                    <p class="text-lg font-semibold">Taux de change</p>
                    <p class="text-sm text-gray-500">Consulter les taux du jour</p>
                </a>
                <a href="{{ route('msl.claims.create') }}" class="rounded-lg bg-white p-6 shadow-sm hover:bg-gray-50">

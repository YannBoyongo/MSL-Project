    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="rounded-lg bg-white p-6 shadow-sm space-y-8">
                ...
                <section>
                    <h3 class="text-lg font-medium text-gray-800">Qu'est-ce que MSL ?</h3>
                    <p class="mt-2 text-sm text-gray-600">
                        MSL est la plateforme de collecte et de suivi des prix des marchandises et des taux de change

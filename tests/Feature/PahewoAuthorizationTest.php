...
class PahewoAuthorizationTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function test_trader_cannot_access_user_management(): void
    {
        ...
        $response = $this->actingAs($user)->get(route('pahewo.users.index'));
    ...
    public function test_data_collector_can_access_price_creation(): void
    {
        ...
        $response = $this->actingAs($user)->get(route('pahewo.commodity-prices.create'));
    ...
    public function test_country_admin_cannot_access_unauthorized_country_market(): void
    {
        ...
        $response = $this->actingAs($user)->get(route('pahewo.markets.index', [
    ...
    public function test_trader_cannot_view_another_traders_claim(): void
    {
        ...
        $response = $this->actingAs($traderA)->get(route('pahewo.claims.show', $claim));
    ...
    public function test_trader_can_create_claim(): void
    {
        ...
        $response = $this->actingAs($user)->get(route('pahewo.claims.create'));
